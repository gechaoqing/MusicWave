...
public class PlayerService extends Service {
	 ...
	 */
	public static final String PLAYSTATE_CHANGED = "com.gecq.musicwave.playstatechanged";

	/**
	 * Indicates that music playback position within a title was changed
	 */
	public static final String POSITION_CHANGED = "com.gecq.musicwave.positionchanged";

	/**
	 * Indicates the meta data has changed in some way, like a track change
	 */
	public static final String META_CHANGED = "com.gecq.musicwave.metachanged";
	 ...
	 */
	public static final String REPEATMODE_CHANGED = "com.gecq.musicwave.repeatmodechanged";

	/**
	 * Indicates the shuffle mode chaned
	 */
	public static final String SHUFFLEMODE_CHANGED = "com.gecq.musicwave.shufflemodechanged";
	 ...
	 */
	public static final String SERVICECMD = "com.gecq.musicwave.musicservicecommand";

	/**
	 * Called to go toggle between pausing and playing the music
	 */
	public static final String TOGGLEPAUSE_ACTION = "com.gecq.musicwave.togglepause";

	/**
	 * Called to go to pause the playback
	 */
	public static final String PAUSE_ACTION = "com.gecq.musicwave.pause";

	/**
	 * Called to go to stop the playback
	 */
	public static final String STOP_ACTION = "com.gecq.musicwave.stop";

	/**
	 * Called to go to the previous track
	 */
	public static final String PREVIOUS_ACTION = "com.gecq.musicwave.previous";

	/**
	 * Called to go to the next track
	 */
	public static final String NEXT_ACTION = "com.gecq.musicwave.next";

	/**
	 * Called to change the repeat mode
	 */
	public static final String REPEAT_ACTION = "com.gecq.musicwave.repeat";

	/**
	 * Called to change the shuffle mode
	 */
	public static final String SHUFFLE_ACTION = "com.gecq.musicwave.shuffle";

	/**
	 * Called to update the service about the foreground state of Apollo's
	 * activities
	 */
	public static final String FOREGROUND_STATE_CHANGED = "com.gecq.musicwave.fgstatechanged";
	 ...
	 * changes
	 */
	public static final String REFRESH = "com.gecq.musicwave.refresh";

	/**
	 * Used by the alarm intent to shutdown the service after being idle
	 */
	private static final String SHUTDOWN = "com.gecq.musicwave.shutdown";

	/**
	 * Called to update the remote control client
	 */
	public static final String UPDATE_LOCKSCREEN = "com.gecq.musicwave.updatelockscreen";
	...
	public void onCreate() {
		...
		final Intent shutdownIntent = new Intent(this, PlayerService.class);
	 ...
	 *
	 * @param storagePath
	 *            The path to mount point for the removed media
	 */
	...
	private void notifyChange(final String what) {
		...
		if (what.equals(META_CHANGED)) {
			...
			if (mFavoritesCache.getSongId(getAudioId()) != null) {
				mFavoritesCache.addSongId(getAudioId(), getTrackName(),
						getAlbumName(), getArtistName());
			}
			// Add the track to the recently played list.
			mRecentsCache.addAlbumId(getAlbumId(), getAlbumName(),
					getArtistName(),
...
//		mRecentWidgetProvider.notifyChange(this, what);
	...
	public boolean openFile(final String path) {
		...
		synchronized (this) {
			...
			if (mCursor == null) {
				...
				if (id != -1
						&& path.startsWith(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI
								.toString())) {
					updateCursor(uri);
	...
	public String getAlbumArtistName() {
		synchronized (this) {
			...
			return mAlbumCursor.getString(mAlbumCursor
	...
	private static final class MusicPlayerHandler extends Handler {
		 ...
		 */
		public MusicPlayerHandler(final PlayerService service,
				final Looper looper) {
			super(looper);
		...
		public void handleMessage(final Message msg) {
			final PlayerService service = mService.get();
			if (service == null) {
				return;
			}
	...
	private static final class MultiPlayer implements
		 ...
		 */
		public MultiPlayer(final PlayerService service) {
			mService = new WeakReference<PlayerService>(service);
