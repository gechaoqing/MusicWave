...
public class MediaButtonIntentReceiver extends WakefulBroadcastReceiver {
            ...
            switch (msg.what) {
                case MSG_LONGPRESS_TIMEOUT:
                    ...
                    if (!mLaunched) {
                        ...
                        i.setClass(context, MusicWaveActivity.class);
                ...
                case MSG_HEADSET_DOUBLE_CLICK_TIMEOUT:
                    ...
                    switch (clickCount) {
                        case 1: command = PlayerService.CMDTOGGLEPAUSE; break;
                        case 2: command = PlayerService.CMDNEXT; break;
                        case 3: command = PlayerService.CMDPREVIOUS; break;
    ...
    private static void startService(Context context, String command) {
        ...
        i.putExtra(PlayerService.FROM_MEDIA_BUTTON, true);
