...
public class Mp3File extends FileWrapper {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5560255415596525504L;
	...
	public String toString() {
		return "Mp3File [bufferLength=" + bufferLength + ", xingOffset="
				+ xingOffset + ", startOffset=" + startOffset + ", endOffset="
				+ endOffset + ", frameCount=" + frameCount + ", bitrates="
				+ bitrates + ", xingBitrate=" + xingBitrate + ", bitrate="
				+ bitrate + ", channelMode=" + channelMode + ", emphasis="
				+ emphasis + ", layer=" + layer + ", modeExtension="
				+ modeExtension + ", sampleRate=" + sampleRate + ", copyright="
				+ copyright + ", original=" + original + ", version=" + version
				+ ", id3v1Tag=" + id3v1Tag + ", id3v2Tag=" + id3v2Tag
				+ ", customTag=" + Arrays.toString(customTag) + ", scanFile="
				+ scanFile + "]";
	}
}
